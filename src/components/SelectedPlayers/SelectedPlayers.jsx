...
const SelectedPlayers = ({ selectedPlayers, handleDeletePlayer, balance, setBalance }) => {
    return (
        <div className='w-11/12 mx-auto mb-60 flex flex-col gap-6'>
            {
                selectedPlayers.length === 0 ? <p className='text-[#131313]/60 font-medium text-lg'>No players selected yet.</p> :
